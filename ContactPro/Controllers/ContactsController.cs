...
namespace ContactPro.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,BirthDate,Address1,Address2,City,State,ZipCode,Email,PhoneNumber,ImageFile")] Contact contact)
        {
            ...
            //ModelState.Remove("Created"); Added here to remove from model if it is deemed required but not found in the form to avoid errors
            ...
            if (ModelState.IsValid)
            {
                ...
                _context.Add(contact); //Persist contact model
                await _context.SaveChangesAsync();//Flush contact record to database
                return RedirectToAction(nameof(Index));//Redirect to the contacts index list
            }
